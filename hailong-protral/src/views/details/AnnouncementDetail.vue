    ...
    <div class="py-12 bg-white">
      <div class="container-wide">
        ...
        <div v-else class="max-w-5xl mx-auto">
          ...
          <!-- 联系方式 -->
          <div v-if="announcement.contactPerson || announcement.contactPhone" class="bg-gradient-to-r from-hailong-primary/5 to-hailong-secondary/5 rounded-xl p-8 mb-6">
            <h2 class="text-xl font-bold text-gray-900 mb-6">
              联系方式
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div v-if="announcement.contactPerson" class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div class="text-gray-900 font-medium">{{ announcement.contactPerson }}</div>
                </div>
              </div>
              <div v-if="announcement.contactPhone" class="flex items-center gap-3">
                <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
                  <svg class="w-5 h-5 text-hailong-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div class="text-gray-900 font-medium">{{ announcement.contactPhone }}</div>
                </div>
              </div>
            </div>
          </div>
